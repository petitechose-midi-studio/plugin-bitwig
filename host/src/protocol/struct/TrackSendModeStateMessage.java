...
/**
 * TrackSendModeStateMessage - Auto-generated Protocol Message
 *
 ...
 */
public final class TrackSendModeStateMessage {
    ...
    public static final MessageID MESSAGE_ID = MessageID.TRACK_SEND_MODE_STATE;

    // Message name for logging (encoded in payload)
    public static final String MESSAGE_NAME = "TrackSendModeState";
    ...
    /**
     * Construct a new TrackSendModeStateMessage
     *
     * @param trackIndex The trackIndex value
     * @param sendIndex The sendIndex value
     * @param sendMode The sendMode value
     */
    public TrackSendModeStateMessage(int trackIndex, int sendIndex, String sendMode) {
     ...
     * @return Decoded TrackSendModeStateMessage instance
     * @throws IllegalArgumentException if data is invalid or insufficient
     */
    public static TrackSendModeStateMessage decode(byte[] data) {
        if (data.length < MIN_PAYLOAD_SIZE) {
            throw new IllegalArgumentException("Insufficient data for TrackSendModeStateMessage decode");
        }
        ...
        return new TrackSendModeStateMessage(trackIndex, sendIndex, sendMode);
    }
