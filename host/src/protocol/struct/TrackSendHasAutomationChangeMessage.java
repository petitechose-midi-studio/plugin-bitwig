...
/**
 * TrackSendHasAutomationChangeMessage - Auto-generated Protocol Message
 *
 * AUTO-GENERATED - DO NOT EDIT
 * Generated from: types.yaml
 *
 * Description: TRACK_SEND_HAS_AUTOMATION_CHANGE message
 *
 * This class is immutable and uses Encoder for encode/decode operations.
 * All encoding is 8-bit binary (Serial8).
 */
public final class TrackSendHasAutomationChangeMessage {
    ...
    public static final MessageID MESSAGE_ID = MessageID.TRACK_SEND_HAS_AUTOMATION_CHANGE;

    // Message name for logging (encoded in payload)
    public static final String MESSAGE_NAME = "TrackSendHasAutomationChange";
    ...
    /**
     * Construct a new TrackSendHasAutomationChangeMessage
     *
     * @param trackIndex The trackIndex value
     * @param sendIndex The sendIndex value
     * @param hasAutomation The hasAutomation value
     */
    public TrackSendHasAutomationChangeMessage(int trackIndex, int sendIndex, boolean hasAutomation) {
     ...
     * @return Decoded TrackSendHasAutomationChangeMessage instance
     * @throws IllegalArgumentException if data is invalid or insufficient
     */
    public static TrackSendHasAutomationChangeMessage decode(byte[] data) {
        if (data.length < MIN_PAYLOAD_SIZE) {
            throw new IllegalArgumentException("Insufficient data for TrackSendHasAutomationChangeMessage decode");
        }
        ...
        return new TrackSendHasAutomationChangeMessage(trackIndex, sendIndex, hasAutomation);
    }
    ...
    public String toString() {
        ...
        sb.append("# TrackSendHasAutomationChange\n");
        sb.append("trackSendHasAutomationChange:\n");
