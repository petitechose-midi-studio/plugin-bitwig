...
/**
 * TrackVolumeModulatedValueStateMessage - Auto-generated Protocol Message
 *
 ...
 */
public final class TrackVolumeModulatedValueStateMessage {
    ...
    public static final MessageID MESSAGE_ID = MessageID.TRACK_VOLUME_MODULATED_VALUE_STATE;

    // Message name for logging (encoded in payload)
    public static final String MESSAGE_NAME = "TrackVolumeModulatedValueState";
    ...
    /**
     * Construct a new TrackVolumeModulatedValueStateMessage
     *
     * @param trackIndex The trackIndex value
     * @param modulatedValue The modulatedValue value
     */
    public TrackVolumeModulatedValueStateMessage(int trackIndex, float modulatedValue) {
     ...
     * @return Decoded TrackVolumeModulatedValueStateMessage instance
     * @throws IllegalArgumentException if data is invalid or insufficient
     */
    public static TrackVolumeModulatedValueStateMessage decode(byte[] data) {
        if (data.length < MIN_PAYLOAD_SIZE) {
            throw new IllegalArgumentException("Insufficient data for TrackVolumeModulatedValueStateMessage decode");
        }
        ...
        return new TrackVolumeModulatedValueStateMessage(trackIndex, modulatedValue);
    }
    ...
    public String toString() {
        ...
        sb.append("# TrackVolumeModulatedValueState\n");
        sb.append("trackVolumeModulatedValueState:\n");
