...
/**
 * LastClickedValueStateMessage - Auto-generated Protocol Message
 *
 ...
 */
public final class LastClickedValueStateMessage {
    ...
    public static final MessageID MESSAGE_ID = MessageID.LAST_CLICKED_VALUE_STATE;

    // Message name for logging (encoded in payload)
    public static final String MESSAGE_NAME = "LastClickedValueState";
    ...
    /**
     * Construct a new LastClickedValueStateMessage
     *
     * @param parameterValue The parameterValue value
     * @param displayValue The displayValue value
     */
    public LastClickedValueStateMessage(float parameterValue, String displayValue) {
     ...
     * @return Decoded LastClickedValueStateMessage instance
     * @throws IllegalArgumentException if data is invalid or insufficient
     */
    public static LastClickedValueStateMessage decode(byte[] data) {
        if (data.length < MIN_PAYLOAD_SIZE) {
            throw new IllegalArgumentException("Insufficient data for LastClickedValueStateMessage decode");
        }
