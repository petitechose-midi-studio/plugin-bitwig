...
import protocol.struct.DeviceChangeMessage;
import protocol.struct.DeviceChangeHeaderMessage;
import protocol.struct.DeviceChildrenMessage;
import protocol.struct.DeviceEnabledStateMessage;
import protocol.struct.DeviceListWindowMessage;
import protocol.struct.DevicePageChangeMessage;
import protocol.struct.DevicePageNamesWindowMessage;
import protocol.struct.DevicePageSelectMessage;
import protocol.struct.DeviceRemoteControlsBatchMessage;
import protocol.struct.DeviceRemoteControlDiscreteValuesMessage;
import protocol.struct.DeviceRemoteControlHasAutomationChangeMessage;
import protocol.struct.DeviceRemoteControlIsModulatedChangeMessage;
import protocol.struct.DeviceRemoteControlNameChangeMessage;
import protocol.struct.DeviceRemoteControlOriginChangeMessage;
import protocol.struct.DeviceRemoteControlRestoreAutomationMessage;
import protocol.struct.DeviceRemoteControlTouchMessage;
import protocol.struct.DeviceRemoteControlUpdateMessage;
import protocol.struct.DeviceSelectMessage;
import protocol.struct.DeviceStateMessage;
import protocol.struct.EnterDeviceChildMessage;
import protocol.struct.ExitToParentMessage;
import protocol.struct.RemoteControlValueMessage;
import protocol.struct.RemoteControlValueStateMessage;
import protocol.struct.RequestDeviceChildrenMessage;
import protocol.struct.RequestDeviceListWindowMessage;
import protocol.struct.RequestDevicePageNamesWindowMessage;
import protocol.struct.ViewStateMessage;
import protocol.struct.LastClickedTouchMessage;
import protocol.struct.LastClickedUpdateMessage;
import protocol.struct.LastClickedValueMessage;
import protocol.struct.LastClickedValueStateMessage;
import protocol.struct.HostDeactivatedMessage;
import protocol.struct.HostInitializedMessage;
import protocol.struct.RequestHostStatusMessage;
import protocol.struct.EnterTrackGroupMessage;
import protocol.struct.ExitTrackGroupMessage;
import protocol.struct.RequestSendDestinationsMessage;
import protocol.struct.RequestTrackListWindowMessage;
import protocol.struct.RequestTrackSendListMessage;
import protocol.struct.SelectMixSendMessage;
import protocol.struct.SendDestinationsListMessage;
import protocol.struct.TrackActivateMessage;
import protocol.struct.TrackArmMessage;
import protocol.struct.TrackArmStateMessage;
import protocol.struct.TrackChangeMessage;
import protocol.struct.TrackListWindowMessage;
import protocol.struct.TrackMuteMessage;
import protocol.struct.TrackMutedBySoloStateMessage;
import protocol.struct.TrackMuteStateMessage;
import protocol.struct.TrackPanMessage;
import protocol.struct.TrackPanHasAutomationStateMessage;
import protocol.struct.TrackPanModulatedValueStateMessage;
import protocol.struct.TrackPanStateMessage;
import protocol.struct.TrackPanTouchMessage;
import protocol.struct.TrackSelectMessage;
import protocol.struct.TrackSendEnabledMessage;
import protocol.struct.TrackSendEnabledStateMessage;
import protocol.struct.TrackSendHasAutomationStateMessage;
import protocol.struct.TrackSendListMessage;
import protocol.struct.TrackSendModeMessage;
import protocol.struct.TrackSendModeStateMessage;
import protocol.struct.TrackSendModulatedValueStateMessage;
import protocol.struct.TrackSendPreFaderStateMessage;
import protocol.struct.TrackSendTouchMessage;
import protocol.struct.TrackSendValueMessage;
import protocol.struct.TrackSendValueStateMessage;
import protocol.struct.TrackSoloMessage;
import protocol.struct.TrackSoloStateMessage;
import protocol.struct.TrackVolumeMessage;
import protocol.struct.TrackVolumeHasAutomationStateMessage;
import protocol.struct.TrackVolumeModulatedValueStateMessage;
import protocol.struct.TrackVolumeStateMessage;
import protocol.struct.TrackVolumeTouchMessage;
import protocol.struct.ResetAutomationOverridesMessage;
import protocol.struct.TransportArrangerAutomationWriteEnabledMessage;
import protocol.struct.TransportArrangerAutomationWriteEnabledStateMessage;
import protocol.struct.TransportArrangerOverdubEnabledMessage;
import protocol.struct.TransportArrangerOverdubEnabledStateMessage;
import protocol.struct.TransportAutomationOverrideActiveStateMessage;
import protocol.struct.TransportAutomationWriteModeMessage;
import protocol.struct.TransportAutomationWriteModeStateMessage;
import protocol.struct.TransportClipLauncherAutomationWriteEnabledMessage;
import protocol.struct.TransportClipLauncherAutomationWriteEnabledStateMessage;
import protocol.struct.TransportClipLauncherOverdubEnabledMessage;
import protocol.struct.TransportClipLauncherOverdubEnabledStateMessage;
import protocol.struct.TransportPlayMessage;
import protocol.struct.TransportPlayingStateMessage;
import protocol.struct.TransportRecordMessage;
import protocol.struct.TransportRecordingStateMessage;
import protocol.struct.TransportStopMessage;
import protocol.struct.TransportTempoMessage;
import protocol.struct.TransportTempoStateMessage;
