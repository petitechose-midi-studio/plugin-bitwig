...
constexpr uint8_t DEVICE_ID = 0x00;        // Device identifier
...
constexpr uint16_t MAX_PAYLOAD_SIZE = 128;    // Max payload bytes
constexpr uint16_t MAX_MESSAGE_SIZE = 256;    // Max total message bytes
