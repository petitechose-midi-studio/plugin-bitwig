/**
 * TransportStopMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TransportStopMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRANSPORT_STOP;
     ...
     */
    static etl::optional<TransportStopMessage> decode(
        ...
        // Decode fields
        bool isStopping;
        if (!decodeBool(ptr, remaining, isStopping)) return etl::nullopt;
