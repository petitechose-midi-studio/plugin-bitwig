...
TRACK_LIST = Message(
    ...
    fields=[track_count, track_index, track_is_nested, parent_group_name, track_list],
    deprecated=True
)

# Legacy bidirectional messages - replaced by command + state pairs
TRACK_VOLUME_CHANGE = Message(
    direction=Direction.TO_HOST,
    intent=Intent.COMMAND,
    description='[DEPRECATED] Track volume change - use TRACK_VOLUME instead',
    fields=[track_index, track_volume, track_volume_display, parameter_is_echo],
    deprecated=True
)
...
TRACK_PAN_CHANGE = Message(
    direction=Direction.TO_HOST,
    intent=Intent.COMMAND,
    description='[DEPRECATED] Track pan change - use TRACK_PAN instead',
    fields=[track_index, track_pan, track_pan_display, parameter_is_echo],
    deprecated=True
)
...
TRACK_ARM_CHANGE = Message(
    direction=Direction.TO_HOST,
    intent=Intent.COMMAND,
    description='[DEPRECATED] Track record arm state change - use TRACK_ARM instead',
    fields=[track_index, track_is_arm],
    deprecated=True
)
...
TRACK_MUTED_BY_SOLO_CHANGE = Message(
    direction=Direction.TO_CONTROLLER,
    intent=Intent.NOTIFY,
    description='[DEPRECATED] Track muted by solo - use TRACK_MUTED_BY_SOLO_STATE instead',
    fields=[track_index, track_is_muted_by_solo],
    deprecated=True
)
...
TRACK_VOLUME_HAS_AUTOMATION_CHANGE = Message(
    direction=Direction.TO_CONTROLLER,
    intent=Intent.NOTIFY,
    description='[DEPRECATED] Use TRACK_VOLUME_HAS_AUTOMATION_STATE instead',
    fields=[track_index, parameter_has_automation],
    deprecated=True
)
...
TRACK_PAN_HAS_AUTOMATION_CHANGE = Message(
    direction=Direction.TO_CONTROLLER,
    intent=Intent.NOTIFY,
    description='[DEPRECATED] Use TRACK_PAN_HAS_AUTOMATION_STATE instead',
    fields=[track_index, parameter_has_automation],
    deprecated=True
)
...
TRACK_VOLUME_MODULATED_VALUE_CHANGE = Message(
    direction=Direction.TO_CONTROLLER,
    intent=Intent.NOTIFY,
    description='[DEPRECATED] Use TRACK_VOLUME_MODULATED_VALUE_STATE instead',
    fields=[track_index, parameter_modulated_value],
    deprecated=True
)
...
TRACK_PAN_MODULATED_VALUE_CHANGE = Message(
    direction=Direction.TO_CONTROLLER,
    intent=Intent.NOTIFY,
    description='[DEPRECATED] Use TRACK_PAN_MODULATED_VALUE_STATE instead',
    fields=[track_index, parameter_modulated_value],
    deprecated=True
)
...
TRACK_SEND_VALUE_CHANGE = Message(
    direction=Direction.TO_HOST,
    intent=Intent.COMMAND,
    description='[DEPRECATED] Track send value change - use TRACK_SEND_VALUE instead',
    fields=[track_index, send_index, send_value, send_display_value, parameter_is_echo],
    deprecated=True
)
...
TRACK_SEND_ENABLED_CHANGE = Message(
    direction=Direction.TO_HOST,
    intent=Intent.COMMAND,
    description='[DEPRECATED] Use TRACK_SEND_ENABLED instead',
    fields=[track_index, send_index, send_is_enabled],
    deprecated=True
)
...
TRACK_SEND_MODE_CHANGE = Message(
    direction=Direction.TO_HOST,
    intent=Intent.COMMAND,
    description='[DEPRECATED] Use TRACK_SEND_MODE instead',
    fields=[track_index, send_index, send_mode],
    deprecated=True
)
...
TRACK_SEND_PRE_FADER_CHANGE = Message(
    direction=Direction.TO_CONTROLLER,
    intent=Intent.NOTIFY,
    description='[DEPRECATED] Use TRACK_SEND_PRE_FADER_STATE instead',
    fields=[track_index, send_index, send_is_pre_fader],
    deprecated=True
)
...
TRACK_SEND_HAS_AUTOMATION_CHANGE = Message(
    direction=Direction.TO_CONTROLLER,
    intent=Intent.NOTIFY,
    description='[DEPRECATED] Use TRACK_SEND_HAS_AUTOMATION_STATE instead',
    fields=[track_index, send_index, parameter_has_automation],
    deprecated=True
)
...
TRACK_SEND_MODULATED_VALUE_CHANGE = Message(
    direction=Direction.TO_CONTROLLER,
    intent=Intent.NOTIFY,
    description='[DEPRECATED] Use TRACK_SEND_MODULATED_VALUE_STATE instead',
    fields=[track_index, send_index, parameter_modulated_value],
    deprecated=True
)
