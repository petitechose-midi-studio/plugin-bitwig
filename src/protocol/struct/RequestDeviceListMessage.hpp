/**
 * RequestDeviceListMessage.hpp - Auto-generated Protocol Struct
 *
...
struct RequestDeviceListMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::REQUEST_DEVICE_LIST;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "RequestDeviceList";
     ...
     */
    static std::optional<RequestDeviceListMessage> decode(const uint8_t* data, uint16_t len) {
        ...
        return RequestDeviceListMessage{};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# RequestDeviceList\nrequestDeviceList:\n");
