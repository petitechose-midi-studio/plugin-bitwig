/**
 * TrackSendEnabledMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackSendEnabledMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_SEND_ENABLED;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackSendEnabled";
     ...
     */
    static std::optional<TrackSendEnabledMessage> decode(
        ...
        return TrackSendEnabledMessage{trackIndex, sendIndex, sendIsEnabled};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackSendEnabled\ntrackSendEnabled:\n");
