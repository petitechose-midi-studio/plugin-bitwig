/**
 * TrackPanModulatedValueStateMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackPanModulatedValueStateMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_PAN_MODULATED_VALUE_STATE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackPanModulatedValueState";
     ...
     */
    static std::optional<TrackPanModulatedValueStateMessage> decode(
        ...
        return TrackPanModulatedValueStateMessage{trackIndex, modulatedValue};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackPanModulatedValueState\ntrackPanModulatedValueState:\n");
