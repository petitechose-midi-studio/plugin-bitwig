/**
 * TrackVolumeHasAutomationChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackVolumeHasAutomationChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_VOLUME_HAS_AUTOMATION_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackVolumeHasAutomationChange";
     ...
     */
    static std::optional<TrackVolumeHasAutomationChangeMessage> decode(
        ...
        return TrackVolumeHasAutomationChangeMessage{trackIndex, hasAutomation};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackVolumeHasAutomationChange\ntrackVolumeHasAutomationChange:\n");
