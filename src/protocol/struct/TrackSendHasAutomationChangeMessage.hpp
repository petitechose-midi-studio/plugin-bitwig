/**
 * TrackSendHasAutomationChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackSendHasAutomationChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_SEND_HAS_AUTOMATION_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackSendHasAutomationChange";
     ...
     */
    static constexpr uint16_t MAX_PAYLOAD_SIZE = 32;
     ...
     */
    static std::optional<TrackSendHasAutomationChangeMessage> decode(
        ...
        return TrackSendHasAutomationChangeMessage{trackIndex, sendIndex, hasAutomation};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackSendHasAutomationChange\ntrackSendHasAutomationChange:\n");
