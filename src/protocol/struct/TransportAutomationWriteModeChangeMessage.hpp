...
struct TransportAutomationWriteModeChangeMessage {
    ...
    std::string automationWriteMode;
    ...
    uint16_t encode(uint8_t* buffer, uint16_t bufferSize) const {
        ...
        encodeString(ptr, automationWriteMode);
    ...
    static std::optional<TransportAutomationWriteModeChangeMessage> decode(
        ...
        // Decode fields
        std::string automationWriteMode;
        if (!decodeString(ptr, remaining, automationWriteMode)) return std::nullopt;
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "  automationWriteMode: \"%s\"\n", automationWriteMode.c_str());
