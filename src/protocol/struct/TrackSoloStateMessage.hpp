/**
 * TrackSoloStateMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackSoloStateMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_SOLO_STATE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackSoloState";
     ...
     */
    static std::optional<TrackSoloStateMessage> decode(
        ...
        return TrackSoloStateMessage{trackIndex, isSolo};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackSoloState\ntrackSoloState:\n");
