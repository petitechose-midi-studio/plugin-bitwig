/**
 * TrackSoloMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackSoloMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_SOLO;
     ...
     */
    static etl::optional<TrackSoloMessage> decode(
        ...
        bool isSolo;
        if (!decodeBool(ptr, remaining, isSolo)) return etl::nullopt;

        return TrackSoloMessage{trackIndex, isSolo};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackSolo\ntrackSolo:\n");
