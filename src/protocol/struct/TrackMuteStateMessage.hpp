/**
 * TrackMuteStateMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackMuteStateMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_MUTE_STATE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackMuteState";
     ...
     */
    static std::optional<TrackMuteStateMessage> decode(
        ...
        return TrackMuteStateMessage{trackIndex, isMute};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackMuteState\ntrackMuteState:\n");
