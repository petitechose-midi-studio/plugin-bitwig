/**
 * TrackSendModulatedValueChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackSendModulatedValueChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_SEND_MODULATED_VALUE_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackSendModulatedValueChange";
     ...
     */
    static std::optional<TrackSendModulatedValueChangeMessage> decode(
        ...
        return TrackSendModulatedValueChangeMessage{trackIndex, sendIndex, modulatedValue};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackSendModulatedValueChange\ntrackSendModulatedValueChange:\n");
