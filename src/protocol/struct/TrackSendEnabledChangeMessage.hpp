/**
 * TrackSendEnabledChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackSendEnabledChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_SEND_ENABLED_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackSendEnabledChange";
     ...
     */
    static std::optional<TrackSendEnabledChangeMessage> decode(
        ...
        bool sendIsEnabled;
        if (!decodeBool(ptr, remaining, sendIsEnabled)) return std::nullopt;

        return TrackSendEnabledChangeMessage{trackIndex, sendIndex, sendIsEnabled};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackSendEnabledChange\ntrackSendEnabledChange:\n");
