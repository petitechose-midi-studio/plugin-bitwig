/**
 * TrackSendModeChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackSendModeChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_SEND_MODE_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackSendModeChange";
     ...
     */
    static std::optional<TrackSendModeChangeMessage> decode(
        ...
        return TrackSendModeChangeMessage{trackIndex, sendIndex, sendMode};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackSendModeChange\ntrackSendModeChange:\n");
