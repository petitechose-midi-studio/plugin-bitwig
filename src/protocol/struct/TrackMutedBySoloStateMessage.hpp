/**
 * TrackMutedBySoloStateMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackMutedBySoloStateMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_MUTED_BY_SOLO_STATE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackMutedBySoloState";
     ...
     */
    static std::optional<TrackMutedBySoloStateMessage> decode(
        ...
        return TrackMutedBySoloStateMessage{trackIndex, isMutedBySolo};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackMutedBySoloState\ntrackMutedBySoloState:\n");
