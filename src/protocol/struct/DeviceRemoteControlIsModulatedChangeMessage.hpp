...
struct DeviceRemoteControlIsModulatedChangeMessage {
    ...
    static constexpr const char* MESSAGE_NAME = "DeviceRemoteControlIsModulatedChange";
    ...
    uint16_t encode(uint8_t* buffer, uint16_t bufferSize) const {
        ...
        Encoder::encodeBool(ptr, isModulated);
    ...
    static std::optional<DeviceRemoteControlIsModulatedChangeMessage> decode(
        ...
        bool isModulated;
        if (!Decoder::decodeBool(ptr, remaining, isModulated)) return std::nullopt;
