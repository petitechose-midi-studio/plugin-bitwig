/**
 * TrackPanChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackPanChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_PAN_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackPanChange";
     ...
     */
    static std::optional<TrackPanChangeMessage> decode(
        ...
        return TrackPanChangeMessage{trackIndex, pan, panDisplay, isEcho};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackPanChange\ntrackPanChange:\n");
