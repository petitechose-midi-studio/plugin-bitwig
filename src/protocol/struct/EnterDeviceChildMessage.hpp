...
struct EnterDeviceChildMessage {
    ...
    static constexpr const char* MESSAGE_NAME = "EnterDeviceChild";
    ...
    uint16_t encode(uint8_t* buffer, uint16_t bufferSize) const {
        ...
        Encoder::encodeUint8(ptr, childIndex);
    ...
    static std::optional<EnterDeviceChildMessage> decode(
        ...
        uint8_t childIndex;
        if (!Decoder::decodeUint8(ptr, remaining, childIndex)) return std::nullopt;
