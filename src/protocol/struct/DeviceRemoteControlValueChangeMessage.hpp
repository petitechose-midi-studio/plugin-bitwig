/**
 * DeviceRemoteControlValueChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct DeviceRemoteControlValueChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::DEVICE_REMOTE_CONTROL_VALUE_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "DeviceRemoteControlValueChange";
     ...
     */
    static constexpr uint16_t MAX_PAYLOAD_SIZE = 70;
     ...
     */
    static std::optional<DeviceRemoteControlValueChangeMessage> decode(
        ...
        return DeviceRemoteControlValueChangeMessage{remoteControlIndex, parameterValue, displayValue, isEcho};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# DeviceRemoteControlValueChange\ndeviceRemoteControlValueChange:\n");
