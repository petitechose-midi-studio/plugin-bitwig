/**
 * LastClickedValueMessage.hpp - Auto-generated Protocol Struct
 *
...
struct LastClickedValueMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::LAST_CLICKED_VALUE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "LastClickedValue";
     ...
     */
    static std::optional<LastClickedValueMessage> decode(
        ...
        return LastClickedValueMessage{parameterValue};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# LastClickedValue\nlastClickedValue:\n");
