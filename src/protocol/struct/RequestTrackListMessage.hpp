/**
 * RequestTrackListMessage.hpp - Auto-generated Protocol Struct
 *
...
struct RequestTrackListMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::REQUEST_TRACK_LIST;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "RequestTrackList";
     ...
     */
    static std::optional<RequestTrackListMessage> decode(const uint8_t* data, uint16_t len) {
