/**
 * TrackSendEnabledStateMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackSendEnabledStateMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_SEND_ENABLED_STATE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackSendEnabledState";
     ...
     */
    static std::optional<TrackSendEnabledStateMessage> decode(
        ...
        return TrackSendEnabledStateMessage{trackIndex, sendIndex, sendIsEnabled};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackSendEnabledState\ntrackSendEnabledState:\n");
