/**
 * TrackVolumeModulatedValueChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackVolumeModulatedValueChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_VOLUME_MODULATED_VALUE_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackVolumeModulatedValueChange";
     ...
     */
    static std::optional<TrackVolumeModulatedValueChangeMessage> decode(
        ...
        return TrackVolumeModulatedValueChangeMessage{trackIndex, modulatedValue};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackVolumeModulatedValueChange\ntrackVolumeModulatedValueChange:\n");
