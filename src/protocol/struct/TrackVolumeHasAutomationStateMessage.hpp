/**
 * TrackVolumeHasAutomationStateMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackVolumeHasAutomationStateMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_VOLUME_HAS_AUTOMATION_STATE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackVolumeHasAutomationState";
     ...
     */
    static std::optional<TrackVolumeHasAutomationStateMessage> decode(
        ...
        return TrackVolumeHasAutomationStateMessage{trackIndex, hasAutomation};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackVolumeHasAutomationState\ntrackVolumeHasAutomationState:\n");
