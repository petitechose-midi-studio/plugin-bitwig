/**
 * TrackPanModulatedValueChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackPanModulatedValueChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_PAN_MODULATED_VALUE_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackPanModulatedValueChange";
     ...
     */
    static std::optional<TrackPanModulatedValueChangeMessage> decode(
        ...
        return TrackPanModulatedValueChangeMessage{trackIndex, modulatedValue};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackPanModulatedValueChange\ntrackPanModulatedValueChange:\n");
