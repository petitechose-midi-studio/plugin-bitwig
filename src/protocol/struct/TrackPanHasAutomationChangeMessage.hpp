/**
 * TrackPanHasAutomationChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackPanHasAutomationChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_PAN_HAS_AUTOMATION_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackPanHasAutomationChange";
     ...
     */
    static std::optional<TrackPanHasAutomationChangeMessage> decode(
        ...
        return TrackPanHasAutomationChangeMessage{trackIndex, hasAutomation};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackPanHasAutomationChange\ntrackPanHasAutomationChange:\n");
