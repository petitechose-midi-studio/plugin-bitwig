...
struct ResetAutomationOverridesMessage {
    ...
    static constexpr const char* MESSAGE_NAME = "ResetAutomationOverrides";
     ...
     */
    static std::optional<ResetAutomationOverridesMessage> decode(const uint8_t* data, uint16_t len) {
