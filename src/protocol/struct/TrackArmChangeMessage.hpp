/**
 * TrackArmChangeMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackArmChangeMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_ARM_CHANGE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackArmChange";
     ...
     */
    static std::optional<TrackArmChangeMessage> decode(
        ...
        return TrackArmChangeMessage{trackIndex, isArm};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackArmChange\ntrackArmChange:\n");
