/**
 * TrackSendModulatedValueStateMessage.hpp - Auto-generated Protocol Struct
 *
...
struct TrackSendModulatedValueStateMessage {
    // Auto-detected MessageID for protocol.send()
    static constexpr MessageID MESSAGE_ID = MessageID::TRACK_SEND_MODULATED_VALUE_STATE;

    // Message name for logging (encoded in payload)
    static constexpr const char* MESSAGE_NAME = "TrackSendModulatedValueState";
     ...
     */
    static std::optional<TrackSendModulatedValueStateMessage> decode(
        ...
        return TrackSendModulatedValueStateMessage{trackIndex, sendIndex, modulatedValue};
    }
    ...
    const char* toString() const {
        ...
        ptr += snprintf(ptr, end - ptr, "# TrackSendModulatedValueState\ntrackSendModulatedValueState:\n");
