...
enum class MessageID : uint8_t {
    ...
    DEVICE_REMOTE_CONTROL_RESTORE_AUTOMATION = 0x0F,  // Controller requests host to restore automation playback for parameter (sets value to modulatedValue)
 ...
 */
constexpr uint8_t MESSAGE_COUNT = 79;
