#include "ViewSwitcherInputHandler.hpp"
...
void ViewSwitcherInputHandler::setupBindings() {
    // === VIEW-LEVEL BINDING ===
...
void ViewSwitcherInputHandler::openSelector() {
...
void ViewSwitcherInputHandler::closeSelector() {
    int index = state_.viewSelector.selectedIndex.get();
