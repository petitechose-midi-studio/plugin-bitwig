#include "RemoteControlInputHandler.hpp"
...
void RemoteControlInputHandler::setupBindings() {
...
void RemoteControlInputHandler::handleValueChange(uint8_t index, float value) {
...
void RemoteControlInputHandler::handleGlobalRestore() {
