...
/**
 * @file RemoteControlInputHandler.hpp
 ...
 */
class RemoteControlInputHandler {
public:
    ...
    // Non-copyable
    RemoteControlInputHandler(const RemoteControlInputHandler&) = delete;
    RemoteControlInputHandler& operator=(const RemoteControlInputHandler&) = delete;
