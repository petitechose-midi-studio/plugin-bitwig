...
DeviceSelectorInputHandler::DeviceSelectorInputHandler(state::BitwigState& state,
...
void DeviceSelectorInputHandler::enterDeviceAtIndex(int selectorIndex) {
    ...
    if (hasChildrenAtDisplayIndex(selectorIndex)) {
        ...
        current_device_index_ = static_cast<uint8_t>(deviceIndex);
...
void DeviceSelectorInputHandler::enterChildAtIndex(int selectorIndex) {
    ...
    protocol_.enterDeviceChild(current_device_index_, itemType, childIndex);
}
...
bool DeviceSelectorInputHandler::hasChildrenAtDisplayIndex(int displayIndex) const {
...
bool DeviceSelectorInputHandler::isShowingChildren() const {
