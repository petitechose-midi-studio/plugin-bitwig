...
LastClickedInputHandler::LastClickedInputHandler(ControllerAPI& api,
...
LastClickedInputHandler::~LastClickedInputHandler() {
    api_.clearScope(scope_);
}

void LastClickedInputHandler::setupInputBindings() {
    api_.onTurned(EncoderID::OPT,
                  [this](float value) { handleEncoderTurn(value); },
                  scope_);
}
