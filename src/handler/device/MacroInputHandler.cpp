...
constexpr EncoderID MACRO_ENCODERS[] = {EncoderID::MACRO_1, EncoderID::MACRO_2, EncoderID::MACRO_3,
                                        EncoderID::MACRO_4, EncoderID::MACRO_5, EncoderID::MACRO_6,
                                        EncoderID::MACRO_7, EncoderID::MACRO_8};
constexpr ButtonID MACRO_BUTTONS[] = {ButtonID::MACRO_1, ButtonID::MACRO_2, ButtonID::MACRO_3,
                                      ButtonID::MACRO_4, ButtonID::MACRO_5, ButtonID::MACRO_6,
...
void MacroInputHandler::handleValueChange(uint8_t index, float value) {
    if (index >= Device::PARAMETER_COUNT) return;
